document.addEventListener("DOMContentLoaded", () => {
  const imageList = document.querySelectorAll(".images_scroll div img");
  ...
  function updateMainImage(index) {
    ...
    thumbnailsContainer.children[currentIndex].classList.add(
      "imagem_selecionada"
    );
  }
  ...
  thumbnailsContainer.addEventListener("click", (e) => {
    ...
    if (thumbnailDiv) {
      const index = Array.from(thumbnailsContainer.children).indexOf(
        thumbnailDiv
      );
