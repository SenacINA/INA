const cardProduto = (produto) => {
  return `<div class='index_body_produto_card' data-id='${produto["id_produto"]}' data-nome='${produto["nome_produto"]}'>;
                <div class='index_body_imagem_produto'>
                    <img id='produto' src='${produto["endereco_imagem_produto"]}' alt='${produto["nome_produto"]}'>
                ...
                <div class='index_body_botoes_produto'>
                    <form method='POST' class='form_adicionar_carrinho'>
                        ...
                        <input type='hidden' name='subcategoria' value='${produto["subcategoria_produto"]}'>
