CREATE DATABASE IF NOT EXISTS e2_database; USE
    e2_database;
...
); CREATE TABLE IF NOT EXISTS imagem_avaliacao(
    -- 23
...
); CREATE TABLE IF NOT EXISTS tag_vinculo(
    -- 27
