...
create table
  if not exists metodo_pagamento ( -- 13
    id_metodo_pagamento int auto_increment primary key,
    tipo_pagamento varchar(50)
  );

create table
  if not exists compra ( -- 5
...
create table
  if not exists imagem_produto ( -- 11
...
create table
  if not exists imagem_carrossel ( -- 12
...
create table
  if not exists historico_acesso ( -- 16
...
create table
  if not exists imagem_avaliacao ( -- 23
...
create table
  if not exists tag ( -- 26
    id_tag int primary key auto_increment,
    nome_tag varchar(200) not null
  );

create table
  if not exists tag_produto ( -- 25
