...
<body>
  ...
  <main class="quadrado_vendedor">
    ...
    <div class="mini_perfil_vendedor">
      <img src="../../image/cliente/editar_perfil/mini_banner_perfil_cliente.png" alt="banner" class="banner_vendedor">
      <img src="../../image/cliente/editar_perfil/perfil_usuario.svg" alt="pfp_vendedor" class="pfp_vendedor">
      <div class="infos_container">
        <div class="nome_vendedor">
          <h1 class="nome_vendedor">Cliente 10</h1>
        </div>
        <div class="produtos_vendedor_container">
          ...
          <p class="produtos_vendedor">Ativo agora</p>
        </div>
    ...
    <div class="edit_foto">
      ...
      <div class="banner_container">
        ...
        <button class="img_container">
          <img src="../../image/cliente/editar_perfil/mini_banner_perfil_cliente.png" class="banner_vendedor_forms">
        </button>
