<div class="base_nav_nav" id="baseNavHeaderMain">
    <div class="base_nav_logo_container">
    ...
    <div class="base_nav_button_container">
        <button class="base_nav_square_button" onclick="pag('cliente/perfil_cliente')">
        ...
        <button class="base_nav_square_button" onclick="pag('cliente/menu_lateral')">
