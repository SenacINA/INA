...
function gerarProdutoCards($quantidade){
    ...
    for ($i = 0; $i < $quantidade; $i++) {
        ...
        if ($i == 0) {
            $imageSrc = "{$PATH_PUBLIC}./image/cliente/produto/cadeira_gamer_size_big.png";
        } else {
        ...
        <div class='index_body_produto_card'>
            ...
            <div class='index_body_botoes_produto'>
                <button class='base_botao btn_blue' onclick=\"pag('{$PATH_VIEW}./cliente/carrinho_vazio', 0)\">
                ...
                <button class='base_botao btn_blue' onclick=\"pag('{$PATH_VIEW}./cliente/produto', 0)\">
                    Comprar
                </button>
            </div>
        </div>";
