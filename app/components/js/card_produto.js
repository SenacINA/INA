const cardProduto = (produto) => {
  return `
      <div class='index_body_produto_card' data-id='${
        produto["id_produto"]
      }' data-nome='${produto["nome_produto"]}'>
        <div class='index_body_imagem_produto'>
          <img id='produto' src='./public/${
        ...
        <div class='index_body_estrela_valor'>
          <div class='index_body_estrela_produto'>
            <p class='estrelas-${Math.ceil(
              produto["media_avaliacoes"]
            )}'>★★★★★</p>
        ...
        <div class='index_body_botoes_produto'>
            ...
            <button data-id='${
              produto["id_produto"]
            }' data-quantidade='1' class='adicionar_carrinho base_botao btn_blue'>
            ...
            <a href='Produto/${
              produto["id_produto"]
            }' class='base_botao btn_blue btn_comprar'>COMPRAR</a>
        </div>
      </div>
    `;
};

const cardProdutoPromo = (produto) => {
  return `
      <div class='index_body_produto_card' data-id='${
        produto["id_produto"]
      }' data-nome='${produto["nome_produto"]}'>
        <div class='index_body_imagem_produto'>
          <div class="promo_container">
            <div class="promo_flag">50% OFF</div>
          </div>
          <img id='produto' src='./public/${
            produto["endereco_imagem_produto"]
          }' alt='${produto["nome_produto"]}'>
...
export default {cardProduto, cardProdutoPromo};
