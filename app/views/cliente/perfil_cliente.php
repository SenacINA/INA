...
include_once("../../models/perfil_cliente.php");
$perfilCliente = new perfilCliente();
$info = $perfilCliente->teste();
?>
...
<body>
  ...
  ?>
  <main>
    <img src="<?= $PATH_PUBLIC, $info["banner_perfil"]?>" alt="banner" class="perfil_cliente_banner">

    <div class="perfil_cliente_content_pfp">
      <div class="perfil_cliente_pfp">
        <img src="<?= $PATH_PUBLIC, $info["foto_perfil"]?>" alt="pfp_cliente">
        <h1>Cliente 10</h1>
      </div>
      ...
      <div class="perfil_cliente_infos_container">
        ...
        <div class="perfil_cliente_contatos_cliente">
          <div class="instagram_cliente">
            ...
            <a href="#" class="perfil_cliente_instagram_cliente"><?= $info["instagram_perfil"]?></a>
          </div>
          ...
          <div class="facebook_cliente">
            ...
            <a href="#" class="perfil_cliente_facebook_cliente"><?= $info["facebook_perfil"]?></a>
          </div>
        </div>
      </div>
      <hr>
