    ...
    <main>
        ...
        <div class="heros-main">
            ...
            <div class="hero-container" id="filipe">
                ...
                <div class="hero-info">
                    ...
                    <ul class="example-2">
                        ...
                        <li class="icon-content">
                            <a
                                href="https://discord.com/channels/@me/649711663674687498"
                                aria-label="Discord"
                                data-social="discord">
                                <div class="filled"></div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <div class="hero-container" id="filipe">
                ...
                <div class="card">
                    <img class="hero-image" src="<?= $PATH_PUBLIC ?>/image/sobre_nos/ana.png" alt="">
                    <div class="details">
                ...
                <div class="hero-info">
                    ...
                    <ul class="example-2">
                        ...
                        <li class="icon-content">
                            <a
                                href="https://discord.com/channels/@me/763117452720472066"
                                aria-label="Discord"
                                data-social="discord">
                                <div class="filled"></div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
